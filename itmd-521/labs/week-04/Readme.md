...
Add the required screenshots here:!![sbt](<sbt -r.png>)

### Screenshot of the printSchema inferred in Python

Screenshot goes here!!![python code](<py code -r.png>)

### Screenshot of the printSchema programmatically in Python

Screenshot goes here!!![py schema](<py schema -r.png>)
### Screenshot of the printSchema via DDL in Python

Screenshot goes here!!![run ](<py run -r.png>)

### Screenshot of the printSchema inferred in Scala

Screenshot goes here!!![scala code](<scala code -r.png>)

### Screenshot of the printSchema programmatically in Scala

Screenshot goes here!!![scala schema](<scala schema -r.png>)

### Screenshot of the printSchema via DDL in Scala

Screenshot goes here!!![run ](<scala run -r.png>)
